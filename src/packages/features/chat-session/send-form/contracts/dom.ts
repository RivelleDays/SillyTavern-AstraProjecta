export const NATIVE_SEND_FORM_ID = "send_form";
export const NATIVE_NON_QR_FORM_ITEMS_ID = "nonQRFormItems";
export const NATIVE_RIGHT_SEND_FORM_ID = "rightSendForm";
export const NATIVE_FORM_SHELD_ID = "form_sheld";
export const NATIVE_OPTIONS_BUTTON_ID = "options_button";
export const NATIVE_OPTIONS_ROOT_ID = "options";
export const NATIVE_EXTENSIONS_MENU_ID = "extensionsMenu";
export const NATIVE_EXTENSIONS_MENU_BUTTON_ID = "extensionsMenuButton";
export const NATIVE_CHARACTER_MANAGEMENT_DROPDOWN_ID =
	"char-management-dropdown";
export const NATIVE_CHAT_CHARACTER_SETTINGS_OVERRIDE_OPTION_ID =
...
export const NATIVE_QUICK_REPLY_CONTAINER_ID = "qr_container";
