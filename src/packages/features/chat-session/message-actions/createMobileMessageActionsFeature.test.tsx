...
function createRevisionStoreStub(
...
function createHistoryStoreStub(
...
function getMessageText(message: HTMLElement): HTMLElement {
...
async function fireMessageTextLongPress(
	message: HTMLElement,
	{
		durationMs = 240,
		moveTo,
...
async function openMoreActionsDrawerForMessage(message: HTMLElement) {
...
async function openRevisionHistoryDrawerForMessage(
	message: HTMLElement,
...
async function waitForDrawerExitAnimation() {
	await act(async () => {
...
function readAstraRevisionRoots(message: unknown): Array<{
	active?: number[];
}> {
	return (
		(
