...
- Reuse shared chat-list row actions for open, rename, delete, and export; opening a chat row may switch SillyTavern, but selecting a Favorite header avatar must not.
