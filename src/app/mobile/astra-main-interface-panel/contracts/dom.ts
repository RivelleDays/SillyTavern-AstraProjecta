export const ASTRA_MAIN_INTERFACE_TRIGGER_ID =
	"astra-main-interface-trigger";
export const ASTRA_MAIN_INTERFACE_PANEL_ID =
	"astra-main-interface-panel";
export const ASTRA_MAIN_INTERFACE_TITLE_ID =
	"astra-main-interface-title";
